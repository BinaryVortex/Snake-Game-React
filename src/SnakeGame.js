        ...
        <div className="how-to-play-card">
          ...
          <div className="htp-list">
            <div className="htp-row">
              <i className="fa-solid fa-keyboard htp-icon blue"></i>
              <span>
                <b>Use Arrow keys</b> or buttons<br />
                <span className="htp-sub">to control the snake</span>
              </span>
            </div>
            <div className="htp-row">
              <i className="fa-solid fa-apple-whole htp-icon red"></i>
              <span>
                <b>Eat</b> <span className="food-icon"></span> to grow and score
              </span>
            </div>
            <div className="htp-row">
              <i className="fa-solid fa-square htp-icon cyan"></i>
              <span>
                <b>Avoid</b> hitting the walls or yourself
              </span>
            </div>
            <div className="htp-row">
              <i className="fa-solid fa-trophy htp-icon gold"></i>
              <span>
                <b>Your highest score</b> is saved!
              </span>
            </div>
          </div>
        </div>
